...
$to = "mail@ukr.net"; 
$email_subject = "Новая заявка на обратный звонок от:  $name";
$email_body = "Вы получили новую заявку на обратный звонок c сайта girih.com.ua.\n\n"."
  		...
  		<div class="row">
  			<div class="col-md-offset-4 col-md-4 col-md-offset-4 text-center">
  				<div class="text_success">
  					<?php if ($success) echo "<p>Заявка на обратный звонок отправлена. Мы свяжемся с вами в ближайщее время.</p>" ?>
